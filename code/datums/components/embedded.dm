...
/datum/component/embedded/Initialize(obj/item/I,
	...
	if(damage > 0)
		var/armor = victim.run_armor_check(limb.body_zone, LETHAL, "Your armor has protected your [limb.name].", "Your armor has softened a hit to your [limb.name].",I.armour_penetration)
