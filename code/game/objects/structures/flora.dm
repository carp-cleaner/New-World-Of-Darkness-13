...
/obj/structure/flora/ausbushes/tallgrass/Initialize(mapload)
	if (!dry)
...
/obj/structure/flora/ausbushes/shortgrass/Initialize(mapload)
...
/obj/structure/flora/ausbushes/redflower/Initialize(mapload)
